...
const AboutMe = () => (
  <Layout>
    ...
    <div>
      ...
      <p>As a developer, I love utilizing professional strengths in multitasking, adaptability, creative thinking, and collaboration with a strong attention to detail (and a little gumption) to elevate user experiences on the web. Currently, my stack is React, modern Javascript, Node.js, Gatsby, and GraphQL. View my resume for a full list of my skills and experience.</p>
